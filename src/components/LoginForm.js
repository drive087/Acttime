...
class LoginForm extends Component{
  ...
  render(){
    return(
        <div>
            <Grid alignItems="center" justify="center" style={{display:'inlineBlock',minHeight:'520px'}}>
            <Grid sm={12} md={4} direction='column' alignItems="center" justify="center">
            <h1>Login ACTTIME</h1>
